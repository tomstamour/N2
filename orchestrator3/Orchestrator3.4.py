...
logger = logging.getLogger('Orchestrator3.4')
...
def main():
    logger.info("Orchestrator3.4 starting...")
    ...
    # Register AFTER nw.start() so Orchestrator3.4's handlers override NW4's
    ...
    try:
        ...
        nw.stop()
        logger.info("Orchestrator3.4 stopped.")
